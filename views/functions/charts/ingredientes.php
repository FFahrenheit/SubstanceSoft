...
<html lang="es">
    ...
    <body class="s-bg">
            ...
            <div align="center">
                <h1 class="text-uppercase text-center">Ingredientes</h2>
                <p class="lead text-center">A continuación se el uso y surtido de los ingredientes durante la semana pasada</p>
