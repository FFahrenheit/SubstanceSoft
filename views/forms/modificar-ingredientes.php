                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <td> <a href="modificar-ingrediente-form.php?clave=<?php echo $row['clave'] ?>" class="btn btn-primary">Modificar</a> </td>
                                <td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                Se removerá de los platillos que lo utilicen
                            </div>
...
<script src="../../js/forms/eliminar-ingrediente.js"></script>
