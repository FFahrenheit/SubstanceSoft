...
<body class="s-bg">
    ...
    <section class="container text-center">
        <p>&nbsp;</p>
        <h1 class="text-uppercase text-center">Listado de roles por usuario</h1>
        <div class="row">
            <div class="container-fluid">
                <table class="table table-hover" style="margin: auto">
                    ...
                    <tbody>
                        ...
                        $query = "select * from permisos GROUP BY username";

                        $sql = mysqli_query($connection, $query) or die("error");

                        while ($row = mysqli_fetch_array($sql)) {
                          $user = $row['username'];
                          $statement = "select permisos.clave as pk, nombre, usuario.username as user, permiso, descripcion from permisos, usuario, funcion where
