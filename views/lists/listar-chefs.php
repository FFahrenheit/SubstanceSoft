...
<body class="s-bg">
    ...
    <section class="container text-center">
        <p>&nbsp;</p>
        <h1 class="text-uppercase text-center">Listado de chefs</h1>
        <div class="row">
            <div class="container-fluid">
                <table class="table table-hover" style="margin: auto">
                    ...
                    <tbody>
                        ...
                        $query = "select * from chefs GROUP BY usuario";

                        $sql = mysqli_query($connection, $query) or die("error");

                        while ($row = mysqli_fetch_array($sql)) {
                          $user = $row['usuario'];
                          $statement = "select chefs.clave as pk, cocina.nombre as descripcion from usuario, chefs, cocina where
